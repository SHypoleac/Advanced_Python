...
def main():
    ...
    print(c1["James"],"Jameses in class 1")
    ...
    print(c1.most_common(2),"The most common names in both classes")

    # TODO: Separate the classes again
    c1.subtract(class2)
    print(c1.most_common(2),"The most common names in class 1")

    # TODO: What's common between the two classes?
    print(c1 & c2,"The same names in both classes")
